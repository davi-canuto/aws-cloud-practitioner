...
- **instance type and resize**: for example, m5.xlarge
- **platform description (operating system)**: for exmaple, Microsoft Windows server or Red Hat enterprise Linux
- **tenancy**: default tenanc or dedicated tenancy
